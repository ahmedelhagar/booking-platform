...
<div class="container-fluid allUsers">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 s-pro<?php if(isset($floatC)){echo $floatC;}elseif($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editCheck'){echo ' float-right';}else{echo ' register';} ?>">
        <?php if($this->uri->segment(2) == 'addEvent' OR $this->uri->segment(2) == 'addEventCheck'){ ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 s-pro">
            <div class="col-lg-12 col-md-12 col-sm-12 s_block">
                ...
                <?php }else{ ?>
                <h4 class="pt-10">إضافة فعالية</h4>
                <?php } ?>
                <?php 
                    $atrr2 = array(
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        تم إضافة الفعالية وسيتم إعلامك عند قبولها.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button></div>';
                    }elseif($this->uri->segment(6) == 'done'){
                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        تم تعديل الفعالية بنجاح.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button></div>';
                    }
                ...
                <label class="float-right mb-0">اسم الفعالية <code>*</code></label>
                ...
                if($this->uri->segment(2) == 'addEventCheck' && isset($p_title)){
                    $title['value'] = $p_title;
                }
                if($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editCheck'){
...
?>
                <p class="a_rules">أدخل عنواناً واضحاً باللغة العربية يصف الفعالية التي تريد أن تضيفها. لا تدخل رموزاً أو كلمات مثل "حصرياً"، "لأول مرة"، "لفترة محدود".. الخ.</p>


                <label class="float-right mb-0">وصف الفعالية <code>*</code></label>
                <?php
                        $content = array(
                            'autocomplete'=>'off',
                            'class'=>'form-control text-right float-right',
                ...
                if($this->uri->segment(2) == 'addEventCheck' && isset($p_content)){
...
?>
                ...
                <label class="float-right mb-0">اختر تصنيف الفعالية الأساسي<code>*</code></label>
                ...
                <?php if($msubtag){foreach($msubtag as $k_mtag => $a_stag){ ?>
                    <div class="s-tags" id="<?php echo $k_mtag; ?>">
                        <label class="float-right mb-0">اختر تصنيف الفعالية الفرعي<code>*</code></label>
                ...
                <?php
                        ...
                        ?>
                    <label class="float-right mb-0">اختر صور الفعالية <code>*</code></label>
                    <?php
                        $p_img1 = array(
                            'type'=>'file',
                            'class'=>'form-control',
...
?>
                    ...
                    <label class="float-right mb-0">بداية الفعالية <code>*</code></label>
                    <?php
                        if($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editCheck'){
                    ...
                    <label class="float-right mb-0">انتهاء الفعالية <code>*</code></label>
                        <div class="form-group from">
                        ...
                        <p class="a_rules">تاريخ وساعة انهاء الفعالية.</p>
                ...
                if($this->uri->segment(2) == 'addEventCheck' && isset($p_tags)){
                    $tags['value'] = $p_tags;
                }
                if($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editCheck'){
...
?>
                <p class="a_rules">اختر العنوان من من الخريطة أو ابحث عنه من هذا الحقل.</p>
                <!-- search input box -->
...
?>
                ...
                ?>
                 ...
                 if($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editCheck'){
                echo form_button($submit,'<span class="fa fa-cogs"></span> تعديل الفعالية');
                 }else{echo form_button($submit,'<span class="fa fa-plus"></span> أضف الفعالية');} 
?>
